...
// Declaración y Asignación de Variables
let numero1 = 5; // Asignamos el valor 15 a la variable numero1
let numero2 = 20; // Asignamos el valor 20 a la variable numero2

// Operadores de Comparación y Lógicos
let sonMayoresQueDiez = (numero1 > 10) && (numero2 > 10); // Verificamos si ambos números son mayores que 10

// Mostrar Resultado en la Consola
console.log("Ambos números son mayores que 10:", sonMayoresQueDiez); // Imprimimos el resultado de la comparación
